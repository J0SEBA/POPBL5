...
public class Principal {
	...
	public Principal() {
		init();
		Vehiculo vehiculo = new Vehiculo(new Point(5,0), new Point(7,2), listaSegmentos, 1);
		Vehiculo vehiculo2 = new Vehiculo(new Point(3,2), new Point(5,0), listaSegmentos, 2);
		Vehiculo vehiculo3 = new Vehiculo(new Point(7,0), new Point(5,2), listaSegmentos, 3);
		Vehiculo vehiculo4 = new Vehiculo(new Point(9,0), new Point(9,2), listaSegmentos, 4);
		Vehiculo vehiculo5 = new Vehiculo(new Point(6,1), new Point(3,0), listaSegmentos, 5);
